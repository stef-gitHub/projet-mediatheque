        ...
        <div class="accueil-bar-background-color col-md-2 float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
            <div class="list-group border-0 text-center text-md-left">
                ...
                <div style="margin-bottom: 1px;" class="collapse" id="menuCD" data-parent="#sidebar">
                    ...
                    <a href="" class="monItemHref hover-color list-group-item" data-parent="#menuCD"><h6 class="monZoom ml-4"><i class="fab fa-whmcs"></i> Gérer</h6></a>
                </div>
                <!-- DVD -->
                ...
                <div style="margin-bottom: 1px;" class="collapse" id="menuDVD" data-parent="#sidebar">
                    ...
                    <a href="#" class="monItemHref hover-color list-group-item" data-parent="#menuDVD"><h6 class="monZoom ml-4"><i class="fab fa-whmcs"></i> Gérer</h6></a>
                </div>
                <!-- Livre numérique -->
