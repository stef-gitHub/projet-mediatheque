        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <%
                        List<Utilisateur> listEleves = (ArrayList<Utilisateur>)request.getAttribute("utilisateurs");
                        for (Utilisateur utilisateur : listEleves){
                    %>
                    <tr>
                        ...
                        <td>
                            <div class="float-right">
                                <input style="margin-right: 50px;" data-toggle="modal" data-target="#updateStudent" type="button" class="btn btn-warning" onclick="update('<%=utilisateur.getId_utilisateur()%>', '<%=utilisateur.getNom().toUpperCase()%>', '<%=utilisateur.getPrenom().substring(0, 1).toUpperCase() + utilisateur.getPrenom().substring(1)%>', '<%=utilisateur.getAdresse()%>', '<%=utilisateur.getCode_postal()%>', '<%=utilisateur.getVille()%>')" value="Modifier"/>
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#supprimerEleve<% out.print(utilisateur.getId_utilisateur());%>">Supprimer</button>

                                <div class="modal fade" id="supprimerEleve<% out.print(utilisateur.getId_utilisateur());%>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
